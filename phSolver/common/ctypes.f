...
c
     ...
     &                                   sevsegtype(itask,15), ierr)
       call MPI_TYPE_HVECTOR((nflow-1)*nsd+10,1,
     &        lstride,sevsegtype(itask,1),sevsegtype(itask,16), ierr)
       call MPI_TYPE_HVECTOR(nflow*nsd+10,1,lstride,sevsegtype(itask,1),
