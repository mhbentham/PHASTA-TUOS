...
c     &         write(*,*) 'restar.f about to call write_restart'
           call write_restart(myrank, lstep, nshg, ndof, time,
     &          qold, acold)
c	   if (myrank.eq.master) write(*,*) 'write_restart is done.'
c           write (irstou) qold
