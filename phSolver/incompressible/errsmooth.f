...
c
        dimension rerrl(npro,nshl,numerr),        xl(npro,nenl,nsd),         
     &            rerrsml(npro,nshl,numerr),       rmassl(npro,nshl)
c
...
c
        ...
        call local(rerr,   rerrl,  ien,    numerr,   'gather  ')
...
c
        call local (rerrsm,   rerrsml,  ien,  numerr,'scatter ')
